...
cleaner는 안정망 역할이나 중요하지 않은 네이티브 자원 회수용으로만 사용하자. **물론 이런 경우라도 불확실성과 성능 저하에 주의해야한다.**

### 아이템 9 - try-finally보다는 try-with-resoureces를 사용하라.
...
* 예외 없이 코드는 더 짧고 분명해지며, 만드러지는 예외 정보도 훨씬 유용하다. 
